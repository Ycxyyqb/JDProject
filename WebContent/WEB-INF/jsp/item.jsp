...
<body style="background-color: white">
	...
	<div class="crazy">
		<span class="crazy618">618狂欢</span> <span class="crazyItemTitle">
			${item.title} </span>
	</div>
	...
	<div class="item">
		...
		<div class="itemInfo">
			<span class="itemInfoTitle"> <span class="new">新品</span>
				${item.title}
			</span>
			<p class="sellPoint">${item.sellPoint }</p>
			<img src="img/618_banner.png">
			<div class="banner">
				<div class="price">
					京 东 价 &nbsp;<span
						style="color: #e4393c; font-family: 'microsoft yahei'; font-size: 22px">￥${item.price/100.0 }</span>
				</div>
				<div class="quantity">
					库 存 数 &nbsp;&nbsp;<span
						style="color: #005ec0; font-family: 'microsoft yahei'; font-size: 20px">${item.num }</span>
				</div>
				<div class="collectNumber">
					<!--收藏数  -->
					收 藏 数 &nbsp;&nbsp;<span
						style="color: #005ec0; font-family: 'microsoft yahei'; font-size: 20px">${item.collect}</span>
				</div>
			</div>
			<div class="destination">
				配 送 至 &nbsp;&nbsp; <span
					style="color: #646fb0; font-family: 'microsoft yahei'; font-size: 14px">
					江西省宜春市袁州区学府路宜春学院 </span> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span
					style="color: #999999; padding-top: 10px; display: inline-block">
					由 京东 发货, 并提供售后服务. 11:10前下单,预计今天送达 </span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span
					style="color: #999999; padding-top: 10px; display: inline-block">
					支持 99元免基础运费(20kg内) </span>
			...
			<div class="chooseBtns">
				<div class="chooseNumber" id="chooseNumber">1</div>
				<div class="operator">
					<div class="add" id="add">+</div>
					<div class="sub" id="sub">-</div>
				</div>
				<form action="addToCart.do" method="post" id="addToCartForm">
					<input hidden type="text" value="${item.id }" name="id"> <input
						type="text" hidden name="number" id="addToCartNumber" value="1">
					<div class="addToCart" id="addToCart">加入购物车</div>
				</form>
	...
	<div class="detail">
		<div class="detailTitle">
			<div class="detailTitleDiv">商品介绍</div>
		</div>
