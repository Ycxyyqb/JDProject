...
<div id="shortcut">
				...
				<span>
					<a href="#">关于我 </a><em class="sp-line"></em>
				</span>
    	        <span>
					<a href="#">手机京东</a>
				</span>
        <div id="erweima" style="display:block;margin-top: -33px;"><img src="img/erweima.png"></div>
</div >
...
<div id = "header">
    ...
    <div id="navitems">
        <div id="spans" width="300px">
            ...
            <div style="display: inline-block;margin-left: 20px"><img src="img/manjian.png"></div>
        </div>
    </div>
...
<div id="categoryDiv">
    ...
    <ul>
        <li onmouseover="fun('#Div1',1)" onmouseout="fun('#Div1',2)"><a href = "#">家用电器</a></li>
        <li onmouseover="fun('#Div2',1)" onmouseout="fun('#Div2',2)"><a href = "#">手机<span class="cate_menu_line">/</span>运营商 /数码</a></li>
        <li onmouseover="fun('#Div3',1)" onmouseout="fun('#Div3',2)"><a href = "#">电脑 /办公</a></li>
        <li onmouseover="fun('#Div4',1)" onmouseout="fun('#Div4',2)"><a href = "#">家居 /家具 /家装 /厨具</a></li>
        <li onmouseover="fun('#Div5',1)" onmouseout="fun('#Div5',2)"><a href = "#">男装 /女装 /童装 /内衣</a></li>
        <li onmouseover="fun('#Div6',1)" onmouseout="fun('#Div6',2)"><a href = "#">美妆 /个护清洁 /  宠物</a></li>
        <li onmouseover="fun('#Div7',1)" onmouseout="fun('#Div7',2)"><a href = "#">女鞋 /箱包 /钟表 /珠宝</a></li>
        <li onmouseover="fun('#Div8',1)" onmouseout="fun('#Div8',2)"><a href = "#">男鞋 /运动 /户外</a></li>
        <li onmouseover="fun('#Div9',1)" onmouseout="fun('#Div9',2)"><a href = "#">房产 /汽车 /汽车用品</a></li>
        <li onmouseover="fun('#Div10',1)" onmouseout="fun('#Div10',2)"><a href = "#">母婴 /玩具乐器</a></li>
        <li onmouseover="fun('#Div11',1)" onmouseout="fun('#Div11',2)"><a href = "#">食品 /酒类 /生鲜 /特产</a></li>
        <li onmouseover="fun('#Div12',1)" onmouseout="fun('#Div12',2)"><a href = "#">艺术 /礼品鲜花 /  农资绿植</a></li>
        <li onmouseover="fun('#Div13',1)" onmouseout="fun('#Div13',2)"><a href = "#">医药保健 /  计生情趣</a></li>
        <li onmouseover="fun('#Div14',1)" onmouseout="fun('#Div14',2)"><a href = "#">图书 /音像 /电子书</a></li>
        <li onmouseover="fun('#Div15',1)" onmouseout="fun('#Div15',2)"><a href = "#">机票 /酒店 /旅游 /生活</a></li>
        <li onmouseover="fun('#Div16',1)" onmouseout="fun('#Div16',2)"><a href = "#">理财 /众筹 /白条 /保险</a></li>
        <li onmouseover="fun('#Div17',1)" onmouseout="fun('#Div17',2)"><a href = "#">安装 /维修 /清洗保养</a></li>
    </ul>
</div>
<div id="popCtn">
    <!--开始轮播图-->
    <div id="carouselBigDiv">
        ...
        <div id="popAds">
            <!--广告图片的位置，轮播图右边的三张-->
            <div id="popAdsImage">
                <img src="img/other1.png" id="ad1">
                <img src="img/other2.png" id="ad2">
                <img src="img/other3.png" id="ad3">
            </div>
            ...
            <div id="popInfo">
                ...
                <p>
                    <span><a href="loginOrRegister.do">登录</a></span>
                    <span><a href="loginOrRegister.do">注册</a></span>
                </p>
                <div class="classBtn">
                    <div class="new">
                        新人福利
                ...
                <div class="tab_head">
                    <span id="tab_headSpan1" onmouseover="change('tab_headSpan1','#span1Div',1)" onmouseout="change('tab_headSpan1','#span1Div',2)">促销</span><em class="sp-line"></em>
                    <span id="tab_headSpan2" onmouseover="change('tab_headSpan2','#span2Div',1)" onmouseout="change('tab_headSpan2','#span2Div',2)">公告</span>
                    <div id="span1Div">
...
<div id="seckill">
    ...
    <div class="seckillAds">
        ...
        <p>
            [京东智能电视]飞利浦（PHILIPS）50PUF6693/T3 50英寸 HDR 金属边框 人工智能语音 4K超高清电视机（银色）
        </p>
    ...
    <div class="seckillAds">
        ...
        <p>
            酷开(coocaa)50K5C 50英寸超高清4K防蓝光护眼电视机HDR技术人工智能语音酷开系统 创维出品(黑色)
        </p>
				<span class ="currentPrice">
					￥1598.00
				</span>
    ...
    <div class="seckillAds">
        ...
        <p>
            小辣椒 红辣椒7X 4GB+64GB 人脸识别 全面屏双摄美拍 微Q八开 移动联通电信4G手机 双卡双待 蓝色
        </p>
				<span class ="currentPrice">
					￥789.00
				</span>
    ...
    <div class="seckillAds">
        ...
        <p>
            东芝(TOSHIBA) TR200系列 240GB SATA3 固态硬盘
        </p>
				<span class ="currentPrice">
					￥1111.00
				</span>
    ...
    <div class="seckillAds">
        ...
        <p>
            Apple iPad Pro 平板电脑 10.5 英寸（64G WLAN版/A10X芯片/Retina屏/Multi-Touch技术 MQDX2CH/A）金色
        </p>
				<span class ="currentPrice">
					￥4186.00
				</span>
...
<div id="enjoy" style="padding-bottom: 10px">
   <div style=" width: 1200px; display: inline-block;height: 450px;margin-left: -190px">
       <div style="position: absolute;display: inline-block;float: left;width: 790px;height: 450px;margin-right: 10px">

       <div class="leftjd">
           <a href="#">
               <div style="padding: 15px 20px 5px 20px">
                 <span style=" font-size: 20px;color: #000000; text-decoration:none; font-weight: bold;text-decoration: none;">京东超市&nbsp;&nbsp;<img src="img/xiangright.png"></span>&nbsp;&nbsp;<span style="font-weight:lighter;text-decoration: none;color: #000000;">精选超值好物品</span>
               </div>
           </a>
           <div>
               <div style="padding:1px 2px 0px 15px;width:220px; ">
                   <a href="#">
                       <img src="img/jdmarket01.png">
                   </a>
               </div>
               <div style="margin-left: 15px;padding-top: 3px">
                   <div class="jdmarket" >
                       <a href="#">
                           <img src="img/jdmarket02.png">
                       </a>
                   </div>
                   <div class="jdmarket">
                       <a href="#">
                           <img src="img/jdmarket03.png">
                       </a>
                   </div>
       ...
       <div class="middlejd">
           ...
           <a href="javascript:void(0)">
               <div style="padding: 20px;">
                   <span style=" font-size: 16px;color: #000000; text-decoration:none;"><img src="img/hlogo.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;恒都京东自营旗舰店</span>
               </div>
           </a>
           <div>
               <div style="padding:1px 2px 0px 15px;width:220px; ">
                   <a href="#">
                       <img src="img/bigmeet.png">
                   </a>
               </div>
               <div>
                   <div class="littlemeet">
                       <a href="#">
                           <img src="img/littlemeet01.png">
                       </a>
                   </div>
                   <div class="littlemeet">
                       <a href="#">
                           <img src="img/littlemeet02.png">
                       </a>
                   </div>
                   <div class="littlemeet">
                       <a href="#">
                           <img src="img/littlemeet03.png">
                       </a>
                   </div>
               </div>
           </div>
       ...
       <div class="rightjd">
           <a href = "#">
               <div class="enjoyContent" style=" display: inline-block;width:400px;height: 400px; ">
                   <img style="width: 400px;height: 400px;" src="img/rightlingshi.png">
...
<!--更多商品展示开始-->
<div id="more">
    <div class="title"><h2>还没逛够</h2></div>
    <div style="width: 1200px;">
        ...
        <a href = "#">
            <div class="moreContent">
                ...
                <p>海信（Hisense）LED43EC350A 43英寸 全高清电视 8G存储 VIDAA3.0 丰富影视教育资源（黑色高光）</p>
                <span>￥1598.00</span>
            </div>
        </a>
        <a href = "#">
...
<div class="other">
    ...
    <div class="other6">
        ...
        <div><p style="padding-bottom: 5px">京东已向全国2661个区县提供自营配送服务，支持货到付款、POS机刷卡和售后上门服务。</p></div>
        <a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看详情</a>
    </div>
