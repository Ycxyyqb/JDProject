...
<body>
  <div class="header">
      <a href="index.do">
          <img src="img/jdlogo.png" alt="京东">
      </a>
      <span>欢迎您</span>
      <!--<span style="float: right;padding-right: 50px">登录页面调查页面</span>-->
      <a href="message.do"  style="outline: rgb(109, 109, 109) none 0px;float: right;padding: 35px 100px 10px 100px;"><img src="img/littlemessage.png">登录页面，调查问卷</a>
  </div>
  <div class="bgColor">
     <div class="bgImg">
         <div class="formDiv">
            <ul class="nav nav-tabs nav-justified nav-tabs" roles="tablist">
             ...
             <div class="tab-content">
                 <div role="tabpanel" class="tab-pane active" id="login">
                     <!--登陆表单部分-->
                     <form class="form-horizontal" method="post" action="index.do" id = "loginForm">
                         <div class="form-group">
                             <label for="inputUsername" class="col-sm-3 control-label">用户名</label>
                             <div class="col-sm-9">
                                 <input type="text" class="form-control" id="inputUsername" placeholder="" onblur="checkInputUsername()" name = "username">
                         ...
                         <div class="form-group"> 
                             ...
                             <div class="col-sm-9">
                                 <input type="password" class="form-control" id="inputPassword"  onblur="checkInputPassword()" name = "password">
                                 <font color="red"><span id = "loginPasswordMsg">${loginPasswordMsg }</span></font>
                             </div>
                         </div>
                         <div class="form-group">
                             <label for="inputPassword" class="col-sm-3 control-label">验证码</label>
                             <div class="col-sm-9">
                                <input type="text" name="yanzhengma"><img onclick="changeimg(this)" src="#"><br>
                                 <font color="red"><span id = "loginyanzhengmaMsg"></span></font>
                             </div>
                         </div>
                         <div class="form-group">
                 ...
                 <div role="tabpanel" class="tab-pane" id="register">
                     ...
                     <form class="form-horizontal" method="post" action="register.do">
                         <div class="form-group">
                             ...
                             <div class="col-sm-9">
                                 <input type="text" class="form-control" id="username" placeholder="" onblur="checkUsername()" name = "username">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-9">
                                 <input type="password" class="form-control" id="password" placeholder="" onblur="checkPassword()" name = "password">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-9">
                                 <input type="text" class="form-control" id="phone" placeholder="" onblur="checkPhone()" name = "phone">
                                 <font color="red"><span id = "registerPhoneMsg">${registerPhoneMsg }</span></font>
                             </div>
                         </div>
                         <div class="form-group">
                             <label for="email" class="col-sm-3 control-label">邮箱</label>
                             <div class="col-sm-9">
                                 <input type="email" class="form-control" id="email" placeholder="" onblur="checkEmail()" name = "email">
                                 <font color="red"><span id = "registerEmailMsg">${registerEmailMsg }</span></font>
                             </div>
                         </div>

                         <div class="form-group">
                             <div class="col-sm-offset-5 col-sm-7">
                                 <button type="submit" class="btn btn-default" onclick = "return register()">注册</button>
                             </div>
                         </div>
                     </form>
                     <!--注册表单部分结束-->
         ...
         <center> <div class="dibu">
            ...
            <div class="links">
              ...
              |
              <a href="javascript:void(0)" target="_self">English Site</a>
            </div>
          <div class="copyright">
